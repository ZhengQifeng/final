<template>
    <div style="height: 100%">
        <div class="adminBox" id="adminPart">
            ...
            <div class="main">
                <div class="search-form">
                    <el-form :inline="true" class="demo-form-inline">
                        <el-form-item label="搜索">
                            <el-input class="search-input" icon="search" v-model="schfilter" placeholder="搜索名称、商家、品牌"></el-input>
                        </el-form-item>
                        <el-form-item>
                ...
                <div class="search-main">
                    <el-table :data="tableData" :default-sort="{prop: 'tableData', order: 'descending'}" style="width: 100%; height: 100%;">
                            ...
                            <template slot-scope="props">
                                <el-form label-position="left" inline class="demo-table-expand">
                                    ...
                                    <el-form-item label="商品产地">
                                        <span>{{ props.row.origin_place }}</span>
                                    </el-form-item>
                                    <el-form-item label="商品价格">
                                        <span>{{ props.row.origin_place }}</span>
                                    </el-form-item>
                                    <el-form-item label="品牌名称">
                                        <span>{{ props.row.brand_name }}</span>
                                    </el-form-item>
                                    <el-form-item label="分类名称">
                                        <span>{{ props.row.fitting_name }}</span>
                                    </el-form-item>
                        ...
                        <el-table-column prop="sale" label="销售额" sortable width="100">
                        </el-table-column>
                        <el-table-column prop="price" label="价格" sortable width="100">
                        </el-table-column>
                        <el-table-column prop="origin_place" label="产地" sortable width="100">
                        </el-table-column>
                        <el-table-column prop="brand_name" label="品牌" sortable width="100">
                        </el-table-column>
                        <el-table-column>
                        </el-table-column>
            ...
            <el-dialog title="编辑" :visible.sync="dialogVisibleEdit" width="30%">
                <el-form label-position="top" label-width="80px" :model="editData">
                    ...
                    <el-form-item label="细分类号">
                        <el-input v-model="editData.classify_ident"></el-input>
                    </el-form-item>
                    <el-form-item label="总分类号">
                        <el-input v-model="editData.fitting_ident"></el-input>
                    </el-form-item>
                    <el-form-item label="品牌号">
                        <el-input v-model="editData.brand_ident"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="库存">
                        <el-input v-model="editData.stock"></el-input>
                    </el-form-item>
                    <el-form-item label="销量">
                        <el-input v-model="editData.sale"></el-input>
                    </el-form-item>
                    <el-form-item label="价格">
                        <el-input v-model="editData.price"></el-input>
                    </el-form-item>
                    <el-form-item label="商家名称">
                        <el-input v-model="editData.business_name"></el-input>
                    </el-form-item>
                    <el-form-item label="产地">
                        <el-input v-model="editData.origin_place"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
            ...
            <el-dialog title="添加" :visible.sync="dialogVisibleInsert" width="30%">
                <el-form label-position="top" label-width="80px" :model="insertData">
                    ...
                    <el-form-item label="库存">
                        <el-input v-model="insertData.stock"></el-input>
                    </el-form-item>
                    <el-form-item label="销量">
                        <el-input v-model="insertData.sale"></el-input>
                    </el-form-item>
                    <el-form-item label="价格">
                        <el-input v-model="insertData.pice"></el-input>
                    </el-form-item>
                    <el-form-item label="商家名称">
                        <el-input v-model="insertData.business_name"></el-input>
                    </el-form-item>
                    <el-form-item label="产地">
                        <el-input v-model="insertData.origin_place"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
...
export default {
    ...
    methods: {
        ...
        EditSubmit() {
            ...
            var that = this;
            this.$http.post('/final/admin/part/Updata', data, { emulateJSON: true }).then((response) => {
                that.editData = {};
                that.$http.post('/final/admin/part', { emulateJSON: true }).then((response) => {
        ...
        DeleteSubmit() {
            ...
            var that = this;
            this.$http.post('/final/admin/part/Delete', data, { emulateJSON: true }).then((response) => {
                that.deleteData = {};
                that.$http.post('/final/admin/part', { emulateJSON: true }).then((response) => {
                    that.tableData = response.body.data;
                    that.tableDataBackups = response.body.data;
        ...
        InsertSubmit() {
            ...
            var that = this;
            this.$http.post('/final/admin/part/Insert', data, { emulateJSON: true }).then((response) => {
    ...
    created() {
        this.$http.post('/final/admin/part', { emulateJSON: true }).then((response) => {
