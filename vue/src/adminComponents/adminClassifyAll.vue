<template>
    <div style="height: 100%">
        <div class="adminBox" id="adminClassifyAll">
            <div class="breadcrumb">
                <el-breadcrumb separator="/">
                    <el-breadcrumb-item>配件分类</el-breadcrumb-item>
                    <el-breadcrumb-item>总分类</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
            <div class="main">
                <div class="search-form">
                    <el-form :inline="true" class="demo-form-inline">
                        <el-form-item label="搜索">
                            <el-input class="search-input" icon="search" v-model="schfilter" placeholder="搜索分类名称"></el-input>
                        </el-form-item>
                        <el-form-item>
                ...
                <div class="search-main">
                    <el-table :data="tableData" :default-sort="{prop: 'tableData', order: 'descending'}" style="width: 100%; height: 100%;">
                        <el-table-column prop="classify_ident" sortable label="分类号" width="180">
                        </el-table-column>
                        <el-table-column prop="name" label="名称" sortable width="180">
                        </el-table-column>
                        <el-table-column prop="backgroundColor" sortable label="背景色" width="180">
                        </el-table-column>
                        <el-table-column>
                        </el-table-column>
            ...
            <el-dialog title="编辑" :visible.sync="dialogVisibleEdit" width="30%">
                <el-form label-position="top" label-width="80px" :model="editData">
                    ...
                    <el-form-item label="背景色">
                        <el-input v-model="editData.backgroundColor"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
            ...
            <el-dialog title="添加" :visible.sync="dialogVisibleInsert" width="30%">
                <el-form label-position="top" label-width="80px" :model="insertData">
                    ...
                    <el-form-item label="背景色">
                        <el-input v-model="insertData.backgroundColor"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
...
export default {
    ...
    methods: {
        ...
        EditSubmit() {
            ...
            var that = this;
            this.$http.post('/final/admin/classifyAll/Updata', data, { emulateJSON: true }).then((response) => {
                that.editData = {};
                that.$http.post('/final/admin/classifyAll', { emulateJSON: true }).then((response) => {
        ...
        DeleteSubmit() {
            ...
            var that = this;
            this.$http.post('/final/admin/classifyAll/Delete', data, { emulateJSON: true }).then((response) => {
                that.deleteData = {};
                that.$http.post('/final/admin/classifyAll', { emulateJSON: true }).then((response) => {
                    that.tableData = response.body.data;
                    that.tableDataBackups = response.body.data;
        ...
        InsertSubmit() {
            ...
            var that = this;
            this.$http.post('/final/admin/classifyAll/Insert', data, { emulateJSON: true }).then((response) => {
    ...
    created() {
        this.$http.post('/final/admin/classifyAll', { emulateJSON: true }).then((response) => {
